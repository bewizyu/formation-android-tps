...
class LoginActivity : AppCompatActivity() {
    ...
    private fun listenToViewModels(){
        //TODO-12 : faire la meme chose pour Login activity
        // Ecouter loginViewModel.userData pour rediriger l'utilisateur vers la page home et afficher un messafe de bienvenue
        //                Toast.makeText(this@LoginActivity, "Bienvenue ${it.fullName}", Toast.LENGTH_LONG).show()
        //                redirectToHome()
        // Ecouter loginViewModel.loading pour l'affichage du loader
        //                 loading.visibility = if(it) View.VISIBLE else View.GONE
        // Ecouter loginViewModel.errorMessage pour l'affichage du message d'erreur
