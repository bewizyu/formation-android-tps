...
//cities
    ...
    try {
        println("shop.getMostExpensiveDeliveredProduct()")
        println("ANSWER => " + shop.customers[2].getMostExpensiveDeliveredProduct())
        println("CORRECT ANSWER => $rubyMine")
    } catch (err: NotImplementedError) {
        println("NOT IMPLEMENTED")
    }
    ...
    try {
        println("shop.getNumberOfTimesProductWasOrdered()")
        println("ANSWER => " + shop.getNumberOfTimesProductWasOrdered(rubyMine))
        println("CORRECT ANSWER => 1")
    } catch (err: NotImplementedError) {
        println("NOT IMPLEMENTED")
    }
